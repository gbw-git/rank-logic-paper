...
and Lemma~\ref{lem:transparent-unique}, there is a $\FP(\leq)$ interpretation
...
(\vec{\consp}(j)) := \vec{c}$ and checks, using Lemma~\ref{lem:compute-automorphisms-labels}, if $\sigma j = j'$.
