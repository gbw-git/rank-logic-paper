...
$\EV_g$ presented in the previous subsection. We first construct a formula
...
We define the closed number terms $\FA{m} := (x\# (x = x))*t$ and $\FA{s} := x\#
(x = x)$, denoting the bound on the domain of $\Phi$ and the size of the
